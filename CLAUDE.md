# Teos Landing Page — Standing Rules

- Brand: navy #222741, sage #5B8F87, cream #F7F4EF; Georgia display, Calibri body. Name is "Teos" (pronounced TAY-oss).
- Never use chest pain, stroke, or other emergency presentations in demos or marketing examples.
- All copy must describe the AI as physician-facing: a physician reviews and signs off before clinical conclusions reach the member. Never depict AI delivering a diagnosis directly to a patient.
